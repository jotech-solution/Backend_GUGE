"""
Django settings for backend_guge project.
...
SECRET_KEY = 'django-insecure-7fp2w&+pvlxlx!xv_(sm$a%_@!95kuwh+kgf4bq#*&31g3w**f'
...
ROOT_URLCONF = 'backend_guge.urls'
...
WSGI_APPLICATION = 'backend_guge.wsgi.application'
